...
path = input('\nSpecify the path to files: for example /Users/krzysztofnalborski/Desktop/Climate_TS/mslpressure/ : ')
path = str(path)
...
startDate = input('\nSpecify starting date of time series: either 1910-01 or 1961-01 :')
...
season1 = 'Winters' + ' ' + str(startDate[0:4]) + '-' + str(endDate[0:4]) 
season2 = 'Springs' + ' ' + str(startDate[0:4]) + '-' + str(endDate[0:4]) 
season3 = 'Summers' + ' ' + str(startDate[0:4]) + '-' + str(endDate[0:4]) 
season4 = 'Autumns' + ' ' + str(startDate[0:4]) + '-' + str(endDate[0:4]) 
...
#Graphs
N = 5
means1 = (uk1, scot1, eng1, wal1, ni1)
...
means2= (uk2, scot2, eng2, wal2, ni2)
